// HTMLCONTENT.JS _________________________________________ */
/**
 * <b>DESCR:</b><br>
 * Stores all the DOM nodes & content. Call these objects
 * & their properties w/ the 'View' class.
 */
// SITE'S DESCRIPTION _____________________________________ */
let text = [
  {
    'id': `subtitle text`,
    'fr': `<span>Ces 7 projets ont été réalisés dans le cadre de ma formation Développeur Front-End auprès d’OpenClassRooms.
            Survolez une vignette pour afficher ses détails, cliquez dessus pour visiter le site web du projet.</span>`,
    'en': `<span>These 7 projects have been made throughout my training year to become a Front-End Developper w/ OpenClassRooms.
            Hover one of these miniatures to display its details, click on it to visit the actual project's website.</span>`
  },
  {
    'id': `test`,
    'fr': `test en français`,
